		...
		<div className='flex flex-col items-center min-h-screen py-2 bg-white'>
			...
			>
				<label className='flex flex-col py-1' htmlFor='nombres'>
					...
					<span className='p-2 m-2 bg-white border-2 border-t-4 border-gray-300 rounded-md shadow-inner'>
						{' '}
						Proyecto Uno Editado{' '}
					</span>
				</label>
				...
				<label className='flex flex-col py-1' htmlFor='apellidos'>
					<label className='mx-2 font-semibold'>Descripcion avance</label>
					<input
						name='apellidos'
						type='text'
						required={true}
				...
				<label className='flex flex-col py-1' htmlFor='apellidos'>
					<label className='mx-2 font-semibold'>Observación del lider</label>
					<span>......</span>
				</label>
				<ButtonLoading
