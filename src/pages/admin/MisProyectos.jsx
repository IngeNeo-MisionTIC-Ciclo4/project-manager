...
const MisProyectos = () => (
	<div className='flex flex-col items-center min-h-screen py-2 bg-white'>
		<div>
			<img src={Banner} alt='MisProyectos' className='w-full mb-10 h-30' />
		</div>
		<table className='border-2 border-black'>
			...
			<tr>
				...
				<th className='p-4 font-normal border-2 border-black'>
					• Conquistar el planeta Marte
				</th>
				<th className='p-4 font-normal border-2 border-black'>
					• Gastar menos de 4000 lt de combustible
				</th>
				...
				<th className=''>
					<button
						type='submit'
						className='col-span-2 p-2 m-2 text-sm font-semibold text-white bg-green-600 rounded-lg shadow'
					>
						Registrar
					</button>
					<button
			...
			<tr>
				...
				<th className='p-4 font-normal border-2 border-black'>
					• Producir 12000 Kvh de energía a partir de fuentes renovables
				</th>
				<th className='p-4 font-normal border-2 border-black'>
